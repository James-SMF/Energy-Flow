...
![Resonance Grid Banner](https://via.placeholder.com/800x200/1a237e/ffffff?text=共振网格+-+能量因连接而共鸣)

## 🎮 游戏概述

《共振网格》是一款基于 8×8 网格的回合制空间解谜游戏。玩家需策略性地放置与升级三类能量塔，以最大化能量收集效率，同时最小化能量损耗。每局游戏仅有 **100 行动点（AP）**，每一次放置与升级决策都至关重要。
